...
var stations = [
    ...
    },
    {
        ...
        icon: "\u26EA",
        question: "Wie viele Behindertenparkplätze gibt es vor dem Veranstalungsort des Konzert zum 1. Advent 2025 des Akkordeonorchester Frankfurter Berg?",
        answers: ["2", "zwei"],
        letter: "K",
        hint: null,
        subRiddle: null,
    ...
    },
    {
        ...
        icon: "\u{1F3E2}",
        question: "Wie viele Menschen sind auf dem Kunstwerk am Jugendhaus Frankfurter Berg abgebildet?",
        answers: ["5", "f\u00FCnf", "fuenf"],
        letter: "A",
        hint: null,
        subRiddle: null,
        enabled: true
    },
    {
        ...
        answers: ["holzsp\u00E4ne", "holzspaene", "holzspane", "holzsp\u00E4hne", "rindenmulch"],
        letter: "P",
        hint: null,
        subRiddle: null,
        enabled: true
    ...
    },
    {
        ...
        answers: ["schneegest\u00F6ber mit brot", "schneegestoeber mit brot", "schneegestober mit brot"],
        letter: "W",
        hint: null,
        subRiddle: null,
        enabled: true
    },
    {
        ...
        icon: "\u{1F4CD}",
        question: "An den Koordinaten <strong class=\"revealed-code\" id=\"code8\">????</strong> liegt ein Grundst\u00FCck. Wie hei\u00DFt der Sohn des Besitzers mit Vor- und Nachnamen?",
    ...
    },
    {
        ...
        icon: "\u{1F3E0}",
        question: "Wie viele S\u00E4ulen stehen im Eingangsbereich der Kita am Neuenberg?",
        answers: ["3", "drei"],
        letter: "R",
    ...
    },
    {
        ...
        subRiddle: {
            question: "\u{1F9EE} Um den Code zu knacken, l\u00F6st diese Aufgabe:<br><br>" +
                "<strong>(Anzahl der Monate im Jahr)</strong> \u00D7 <strong>(Anzahl der Planeten im Sonnensystem)</strong> + <strong>(Anzahl der Bundesl\u00E4nder Deutschlands)</strong> = ?",
            answers: ["112"],
            revealText: "112"
        },
        enabled: true
